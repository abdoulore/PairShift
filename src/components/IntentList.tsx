          ...
          <div className="card intent" key={i.id}>
            <div>
              <div className="pair">
                ...
                <span className="badge">{i.mode === "live" ? "Live" : "Paper"}</span>
            ...
            <div>
              {i.execution && !i.execution.error ? (
                ...
                <div style={{ fontSize: 13 }}>
                  <span className="ink2">{i.to} vs {i.from}:</span>{" "}
                  <span className="num">{e.changePct >= 0 ? "+" : ""}{e.changePct.toFixed(2)}%</span>{" "}
                  <span className="muted">of {need > 0 ? "+" : ""}{need}%</span>
